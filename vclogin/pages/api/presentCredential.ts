  ...
  try {
    ...
    if (method === "GET") {
      ...
      uploadMiddleware(req, res, async (err: Error | null) => {
        ...
        // TODO figure out why the presentation proofs just stopped working
        // TODO or just switch to using correct gx credentials directly
            ...
            .then(({ data: loginRequest }) =>
              hydraAdmin
                ...
                .then(({ data: body }) => {
                  ...
                  redis.set(challenge, String(body.redirect_to), EXPIRY_MS, MAX_AGE);
                  console.log("Wrote redirect for "+userDID+" to redis: "+String(body.redirect_to));
